  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          Thank you to the ongoing support and work together on the Internet
          Computer Protocol. Working alongside other Projects, Decentralized
          exchanges, and Wallets to ensure a brighter future on ICP.
        </p>
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
          <a
            ...
            style={{
              ...
              textShadow:
                "0 0 10px var(--neon-white), 0 0 20px var(--neon-white)",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.color = "var(--neon-orange)";
              e.currentTarget.style.textShadow =
                "0 0 15px var(--neon-orange), 0 0 30px var(--neon-orange)";
            }}
            onMouseLeave={(e) => {
