  ...
  return (
    <section className="relative w-full py-12 px-4 border-t border-white/10">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <strong>Legal Disclaimer:</strong> $BITTYICP is a meme coin with no
          intrinsic value or expectation of financial return. $BITTYICP is for
          entertainment purposes only. When you purchase $BITTYICP, you are
