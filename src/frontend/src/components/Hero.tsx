...
export default function Hero() {
    ...
    const handleNewToICP = () => {
        window.open('https://internetcomputer.org/nns', '_blank', 'noopener,noreferrer');
    };
    ...
    const handleTokenDashboardClick = () => {
        ...
        if (tokenDashboardSection) {
            tokenDashboardSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }
    };
    ...
    const handleVotingClick = () => {
        window.open('https://bittyvoting-lso.caffeine.xyz/', '_blank', 'noopener,noreferrer');
    };
    ...
    const handleMemePageClick = () => {
        window.open('https://bittyicpmeme-ebv.caffeine.xyz/', '_blank', 'noopener,noreferrer');
    };
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-center">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    >
                        ...
                        <span className="relative z-10 drop-shadow-glow-orange-intense">NEW TO ICP?</span>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">TOKEN DASHBOARD</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">GAMES</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">ROADMAP</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">VOTING</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">BITTYICP BLING</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                    ...
                    >
                        <div className="absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" />
                        <Sparkles className="mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                        <span className="relative z-10 drop-shadow-glow-orange-intense">MEME PAGE</span>
                        <Sparkles className="ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" />
                    </Button>
                </div>
            </div>
