...
function FeaturedCharacter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-20 px-4 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group flex justify-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-neon-orange leading-relaxed group-hover:scale-105 transition-transform duration-300", children: "BITTY DUCK BLAST" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block group",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-neon-orange leading-relaxed group-hover:scale-105 transition-transform duration-300", children: "FLY BITTY FLY" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block group",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-neon-orange leading-relaxed group-hover:scale-105 transition-transform duration-300", children: "BITTY BUILDER" })
          }
        ) })
      ] }),
...
function BankModal({ isOpen, onClose }) {
  reactExports.useEffect(() => {
    if (isOpen) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            role: "presentation",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-yellow-400 via-neon-orange to-yellow-600 rounded-3xl blur-3xl opacity-60 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "relative bg-black rounded-3xl border-4 border-yellow-400 shadow-2xl p-4 sm:p-6 md:p-8",
                  style: {
                    boxShadow: "0 0 40px rgba(250,204,21,0.6), 0 0 80px rgba(250,204,21,0.3)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-yellow-400 rounded-2xl blur-2xl opacity-40" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                ...
                `
                        ...
                        children: "BITTY ICP BANK COMING VERY SOON"
                      }
                    ) })
                  ]
                }
...
function Hero() {
  ...
  const [showBank, setShowBank] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-40 right-10 w-72 h-72 bg-neon-blue rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-pink via-neon-blue to-neon-cyan rounded-3xl blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-800 to-purple-900 rounded-3xl p-4 border-4 border-neon-blue shadow-2xl transform group-hover:scale-105 transition-transform duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          style: {
            ...
            lineHeight: "1.6",
            color: "#FFFFFF",
            textShadow: "0 0 20px #1E95CC, 0 0 40px #1E95CC, 0 0 60px #1E95CC"
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-white opacity-0 group-hover:opacity-10 blur-2xl transition-opacity duration-300" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BankModal, { isOpen: showBank, onClose: () => setShowBank(false) })
  ] });
}
...
function NewsBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed top-24 sm:top-28 left-0 right-0 z-40 overflow-hidden pointer-events-none h-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: "📰 NEWS — CLICK TO READ LATEST UPDATES 📰"
          }
        )
      }
    ) }),
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "dialog",
      {
        open: true,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, #1a0040 0%, #0d0030 50%, #1a0050 100%)",
                border: "2px solid #FFD700"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "WHAT A GREAT DAY IT IS TO BE A PART OF BITTY ON ICP!"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(90deg, transparent, #FFD700, #a78bfa, transparent)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl flex-shrink-0 mt-0.5", children: "🎮" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: "TOURNAMENT IS LIVE — GO TO GAMES AND PLAY BITTY BUILDER!"
                          }
                        )
                      ]
                    }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "BITTY ICP BANK COMING SOON!!!"
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    onMouseLeave: (e) => {
                      e.currentTarget.style.background = "rgba(30, 0, 60, 0.9)";
                      e.currentTarget.style.transform = "scale(1)";
                    },
                    "data-ocid": "news.play_button",
                    children: "🎮 PLAY BITTY BUILDER"
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(90deg, transparent, #a78bfa, #FFD700, transparent)"
                    }
                  }
                )
              ]
...
function TopNavigation() {
  ...
  const goldItemClass = "group relative w-full px-4 sm:px-6 py-3 sm:py-4 bg-neon-blue/20 hover:bg-neon-blue text-white font-bold text-base sm:text-lg rounded-xl shadow-lg transition-all duration-300";
  const goldItemStyle = {
    border: "2px solid #FFD700",
    boxShadow: "0 0 6px rgba(255,215,0,0.3)"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-900/95 via-purple-800/95 to-indigo-900/95 backdrop-blur-md border-b-4 border-neon-blue shadow-neon-blue-intense", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-16 sm:h-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          (item) => item.type === "contractId" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      "aria-label": "Copy Contract ID",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-lg bg-white opacity-0 group-hover/btn:opacity-10 blur-xl transition-opacity duration-300" }),
                        copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-white opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-300" })
              ]
            },
            item.label
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function AppContent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(NewsBanner, {}),
