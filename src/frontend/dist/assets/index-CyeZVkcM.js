...
function ContractId() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-12 px-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-10 left-10 w-48 h-48 bg-neon-orange rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-10 right-10 w-48 h-48 bg-neon-cyan rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex flex-col sm:flex-row items-center justify-center gap-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 bg-black/50 backdrop-blur-sm rounded-2xl px-8 py-6 border-4 border-white/40 shadow-neon-white-intense group hover:border-neon-orange transition-all duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-neon-orange opacity-0 group-hover/btn:opacity-40 blur-2xl transition-opacity duration-300" }),
            copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-base whitespace-nowrap drop-shadow-glow-orange-intense", children: "Copied!" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-5 w-5 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-base whitespace-nowrap drop-shadow-glow-orange-intense", children: "Copy" })
            ] })
          ]
        }
      )
...
function FeaturedCharacter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-20 px-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/4 w-96 h-96 bg-neon-orange rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 right-1/4 w-96 h-96 bg-neon-cyan rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob animation-delay-2000" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: "WHEN YOU'RE HODLING BITTY, YOUR HODLING HISTORY"
        }
      ) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group flex justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan rounded-3xl blur-3xl opacity-40 group-hover:opacity-60 transition-opacity duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-800/60 to-purple-900/60 backdrop-blur-sm rounded-3xl p-6 border-4 border-neon-orange/50 shadow-2xl transform group-hover:scale-105 transition-transform duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "video",
          {
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative py-8 px-4 pb-24" });
}
function Games() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "games", className: "relative py-20 px-4 mb-20 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-purple-900/70 via-purple-800/60 to-purple-900/70" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-10 left-10 w-64 h-64 bg-neon-pink/15 rounded-full blur-3xl animate-blob" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-10 right-10 w-80 h-80 bg-neon-cyan/15 rounded-full blur-3xl animate-blob animation-delay-2000" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-neon-orange/15 rounded-full blur-3xl animate-blob animation-delay-4000" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan drop-shadow-glow-cyan mb-4 animate-pulse-slow", children: "GAMES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "h-12 w-12 text-neon-cyan drop-shadow-glow-cyan animate-bounce" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl sm:text-3xl md:text-4xl font-bold text-neon-orange drop-shadow-glow-orange", children: "LEVEL UP WITH BITTY" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "h-12 w-12 text-neon-pink drop-shadow-glow-pink animate-bounce animation-delay-1000" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-neon-orange drop-shadow-glow-orange-intense leading-relaxed group-hover:scale-105 transition-transform duration-300 animate-pulse-slow", children: "BITTY DUCK BLAST" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block group",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-neon-orange drop-shadow-glow-orange-intense leading-relaxed group-hover:scale-105 transition-transform duration-300 animate-pulse-slow", children: "FLY BITTY FLY" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-purple-800/70 to-purple-900/70 backdrop-blur-md border-4 border-neon-cyan/50 rounded-3xl p-8 shadow-2xl hover:border-neon-pink/70 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block group",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-neon-orange drop-shadow-glow-orange-intense leading-relaxed group-hover:scale-105 transition-transform duration-300 animate-pulse-slow", children: "BITTY BUILDER" })
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex justify-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-neon-pink rounded-full animate-ping" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-neon-orange rounded-full animate-ping animation-delay-1000" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 bg-neon-cyan rounded-full animate-ping animation-delay-2000" })
      ] })
    ] })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            role: "presentation",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan rounded-3xl blur-3xl opacity-60 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-black rounded-3xl border-4 border-neon-orange shadow-neon-orange-intense p-4 sm:p-6 md:p-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-neon-orange rounded-2xl blur-2xl opacity-50" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative rounded-2xl overflow-hidden border-4 border-neon-orange shadow-neon-orange-intense", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 sm:mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "BITTY BLING COMING SOON"
                  }
                ) })
              ] })
            ]
...
function FireworksTitle() {
  ...
  reactExports.useEffect(() => {
    ...
    const drawICPSymbol = (ctx2, x2, y, size, rotation, alpha) => {
      ctx2.save();
      ctx2.translate(x2, y);
      ctx2.rotate(rotation);
      ctx2.globalAlpha = alpha;
      ctx2.strokeStyle = "currentColor";
      ctx2.lineWidth = size / 8;
      ctx2.lineCap = "round";
      ctx2.beginPath();
      ctx2.arc(-size / 4, 0, size / 3, 0, Math.PI * 2);
      ctx2.stroke();
      ctx2.beginPath();
      ctx2.arc(size / 4, 0, size / 3, 0, Math.PI * 2);
      ctx2.stroke();
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FireworksTitle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 left-10 w-72 h-72 bg-neon-pink rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-40 right-10 w-72 h-72 bg-neon-orange rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 left-1/2 w-72 h-72 bg-neon-cyan rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan rounded-3xl blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-800 to-purple-900 rounded-3xl p-4 border-4 border-neon-orange shadow-2xl transform group-hover:scale-105 transition-transform duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-neon-cyan font-black mb-16 drop-shadow-glow-cyan leading-tight px-4 animate-pulse-slow", children: "The OG Crypto Mascot Returns 🚀" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "NEW TO ICP?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "TOKEN DASHBOARD" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "GAMES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "ROADMAP" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "VOTING" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "BITTYICP BLING" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-orange opacity-0 group-hover:opacity-80 blur-2xl transition-opacity duration-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "mr-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 drop-shadow-glow-orange-intense", children: "MEME PAGE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "ml-2 h-6 w-6 group-hover:rotate-180 transition-transform duration-500 relative z-10" })
            ]
          }
        )
...
function LegalDisclaimer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full py-12 px-4 border-t border-white/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-white rounded-full mix-blend-multiply filter blur-3xl opacity-5" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "p",
      {
        className: "text-sm text-white/60 leading-relaxed",
        style: { textShadow: "0 0 10px rgba(255, 255, 255, 0.3)" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Legal Disclaimer:" }),
          " $BITTYICP is a meme coin with no intrinsic value or expectation of financial return. $BITTYICP is for entertainment purposes only. When you purchase $BITTYICP, you are agreeing that you have seen this disclaimer."
        ]
      }
    ) })
  ] });
...
function Partnerships() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      id: "partnerships",
      className: "relative w-full py-16 px-4 border-t border-white/10",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Thank you to the ongoing support and work together on the Internet Computer Protocol. Working alongside other Projects, Decentralized exchanges, and Wallets to ensure a brighter future on ICP."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center items-center gap-6 md:gap-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://oisy.com",
...
function Socials() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-900/95 via-indigo-900/95 to-purple-900/95 backdrop-blur-md border-t-4 border-neon-cyan/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-neon-orange font-bold text-lg sm:text-xl drop-shadow-glow-orange tracking-wider", children: "SOCIALS" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-2 sm:gap-4", children: socialLinks.map((social) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4 text-neon-cyan group-hover:text-neon-pink transition-colors duration-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-xs sm:text-sm drop-shadow-glow-cyan group-hover:drop-shadow-glow-pink transition-all duration-300", children: social.name })
          ]
        },
        social.name
      );
...
function Story() {
  const stories = [
    {
      title: "The Genesis",
      description: "Bitty was there when Bitcoin was born — present at the first block mined. A witness to history, a legend in the making.",
      color: "neon-orange"
    },
    {
      title: "The Original",
      description: "He was the first meme mascot in crypto, featured on the original Bitcoin website. Before Doge, before Pepe, there was Bitty.",
      color: "neon-pink"
    },
    {
      title: "The Comeback",
      description: "Now, Bitty is making his comeback on the Internet Computer (ICP), ready to show other memes how it's done. The OG is back!",
      color: "neon-cyan"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "community", className: "relative py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl sm:text-6xl md:text-7xl font-black text-white mb-4 softer-glow-title", children: [
        "The Legend of",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon-orange softer-glow-orange", children: "Bitty" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-2 bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan mx-auto rounded-full" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: stories.map((story) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-20 h-20 mb-6 group-hover:rotate-12 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/90 leading-relaxed", children: story.description })
        ] })
      },
      story.title
    )) })
...
function TokenDashboard() {
  var _a2;
  const [dexData, setDexData] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const interval = setInterval(fetchDexscreenerData, 3e4);
    return () => clearInterval(interval);
  }, []);
  const formatNumber = (num) => {
    if (num === void 0 || num === null) return "$0.00";
    if (num >= 1e6) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 right-10 w-64 h-64 bg-neon-orange rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 left-10 w-64 h-64 bg-neon-purple rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-orange via-neon-pink to-neon-cyan rounded-3xl blur-xl opacity-60" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-3xl p-8 border-4 border-neon-orange shadow-neon-orange", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block animate-spin rounded-full h-12 w-12 border-4 border-neon-orange border-t-transparent" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-white drop-shadow-glow-white", children: "Loading live data from Dexscreener..." })
                ] }) })
              ] }) : error || !dexData ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-orange via-neon-pink to-neon-cyan rounded-3xl blur-xl opacity-60" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-3xl p-8 border-4 border-neon-orange shadow-neon-orange", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-white drop-shadow-glow-white", children: "Live data temporarily unavailable" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/60 drop-shadow-glow-white", children: "Please check back shortly or view the chart below" })
                ] }) })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-neon-orange rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-300" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl p-6 border-4 border-neon-orange shadow-neon-orange", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white/80 drop-shadow-glow-white mb-2", children: "Current Price" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-black text-white drop-shadow-glow-orange-intense", children: formatPrice(dexData.priceUsd) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 mt-2", children: "Live from Dexscreener" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-neon-orange rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-300" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl p-6 border-4 border-neon-orange shadow-neon-orange", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white/80 drop-shadow-glow-white mb-2", children: "24h Volume" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-black text-white drop-shadow-glow-orange-intense", children: formatNumber((_a2 = dexData.volume) == null ? void 0 : _a2.h24) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 mt-2", children: "Trading volume last 24 hours" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-neon-orange rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-300" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl p-6 border-4 border-neon-orange shadow-neon-orange", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white/80 drop-shadow-glow-white mb-2", children: "Market Cap" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-black text-white drop-shadow-glow-orange-intense", children: formatNumber(dexData.marketCap || dexData.fdv) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 mt-2", children: "Fully Diluted Valuation" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-orange via-neon-pink to-neon-cyan rounded-2xl blur-xl opacity-60" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl p-6 border-4 border-neon-orange shadow-neon-orange", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Trade on ICPSwap" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-cyan via-neon-pink to-neon-orange rounded-3xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-3xl p-4 border-4 border-neon-cyan shadow-neon-cyan h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "iframe",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/60 drop-shadow-glow-white", children: "Live data from Dexscreener • Auto-refreshes every 30 seconds • Token Pair: wkyqn-qqaaa-aaaar-qbyxq-cai" }) })
        ] })
      ]
    }
  );
...
function TopNavigation() {
  ...
  const handleCopyContractId = async (e) => {
    e.stopPropagation();
    try {
      await navigator.clipboard.writeText(contractId);
      setCopied(true);
  ...
  const menuItems = [
    ...
    { label: "CONTRACT ID", type: "contractId" }
  ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-900/95 via-purple-800/95 to-indigo-900/95 backdrop-blur-md border-b-4 border-neon-orange shadow-neon-orange-intense", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-16 sm:h-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "drop-shadow-glow-orange-intense relative z-10", children: "A BITTY MORE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChevronDown,
              {
      ...
      isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-full mt-4 left-1/2 -translate-x-1/2 w-[90vw] sm:w-[400px] md:w-[450px] bg-gradient-to-br from-purple-900/98 via-indigo-900/98 to-purple-800/98 backdrop-blur-xl rounded-3xl border-4 border-neon-orange shadow-neon-orange-intense p-4 sm:p-6 animate-in fade-in slide-in-from-top-2 duration-300", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: menuItems.map(
          (item) => item.type === "contractId" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "drop-shadow-glow-orange-intense relative z-10 flex-shrink-0", children: item.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      "aria-label": "Copy Contract ID",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-lg bg-neon-orange opacity-0 group-hover/btn:opacity-30 blur-xl transition-opacity duration-300" }),
                        copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 relative z-10" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-xs whitespace-nowrap drop-shadow-glow-orange", children: "Copied!" })
                        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-4 w-4 relative z-10" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-xs whitespace-nowrap drop-shadow-glow-orange", children: "Copy" })
                        ] })
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-neon-orange opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-300" })
              ]
            },
            item.label
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: "group relative w-full px-4 sm:px-6 py-3 sm:py-4 bg-neon-orange/20 hover:bg-neon-orange text-white font-bold text-base sm:text-lg rounded-xl shadow-lg transition-all duration-300 border-2 border-white/30 hover:border-white/50",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "drop-shadow-glow-orange-intense relative z-10", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-neon-orange opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-300" })
              ]
            },
            item.label
...
function Whitepaper() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "whitepaper", className: "relative py-20 px-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 left-10 w-64 h-64 bg-neon-pink rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 right-10 w-64 h-64 bg-neon-cyan rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-6 text-neon-orange drop-shadow-glow-orange animate-pulse-slow", children: "ROADMAP" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-neon-pink via-neon-orange to-neon-cyan rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-3xl p-8 sm:p-12 md:p-16 border-4 border-neon-cyan shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-8 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-16 h-16 text-neon-orange drop-shadow-glow-orange animate-pulse-slow" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "w-16 h-16 text-neon-cyan drop-shadow-glow-cyan animate-pulse-slow animation-delay-1000" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "the-journey", className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl sm:text-5xl md:text-6xl font-black animate-flash-orange-white", children: "THE JOURNEY" })
            }
          ) })
        ] })
      ] })
...
function AppContent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopNavigation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-16 sm:pt-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedCharacter, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Story, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Games, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Whitepaper, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TokenDashboard, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ContractId, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Partnerships, {}),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(J, { attribute: "class", defaultTheme: "dark", enableSystem: false, children: [
...
const TokenMetric = Record({
  "status": Text,
  "marketCap": Opt(Float64),
  "lastUpdated": Int,
  "volume": Opt(Float64),
  "price": Opt(Float64)
});
...
Service({
  "addNewsUpdate": Func([Text, Text], [Nat], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "getAllNewsUpdates": Func([], [Vec(NewsUpdate)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getLiveWalletBalances": Func(
    [Vec(Nat8), Opt(Vec(Nat8)), Text],
    [Nat],
    []
  ),
  "getNewsUpdate": Func([Nat], [Opt(NewsUpdate)], ["query"]),
  "getNewsUpdatesByContent": Func(
    [Text],
    [Vec(NewsUpdate)],
    ["query"]
  ),
  "getNewsUpdatesByDateRange": Func(
    [Int, Int],
    [Vec(NewsUpdate)],
    ["query"]
  ),
  "getNewsUpdatesByTitle": Func(
    [Text],
    [Vec(NewsUpdate)],
    ["query"]
  ),
  "getNewsUpdatesPaginated": Func(
    [Nat, Nat],
    [Vec(NewsUpdate)],
    ["query"]
  ),
  "getSortedNewsUpdates": Func([], [Vec(NewsUpdate)], ["query"]),
  "getTokenMetrics": Func([], [TokenMetric], []),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
